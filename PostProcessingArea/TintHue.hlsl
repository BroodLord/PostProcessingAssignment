...
float4 main(PostProcessingInput input) : SV_Target
{
    ...
    float3 NewColour;
    //
    NewColour.r = lerp(gTintHueColour1.r, gTintHueColour2.r, input.areaUV.y);
    NewColour.b = lerp(gTintHueColour1.b, gTintHueColour2.b, input.areaUV.y);
    NewColour.g = lerp(gTintHueColour1.g, gTintHueColour2.g, input.areaUV.y);
	//// Sample a pixel from the scene texture and multiply it with the tint colour (comes from a constant buffer defined in Common.hlsli)
